  ...
  >
     ...
     >
      <el-form-item label="员工编号" prop="id" >
       ...
       <el-form-item label="当前部门名称" prop="predepartmentname" >
         <el-input v-model="forms.employee.departmentname" :disabled="true"></el-input>
       </el-form-item>
	   <el-form-item label="新部门名称" prop="departmentid">
		 <el-select v-model="forms.departmentid">
		 	<el-option v-for="v in val" :label="v.name" :value="v.id" :key="v.id" ></el-option>
		 </el-select>
	   </el-form-item>
...
import {selectByPrimaryKey,insertdepartment,selectdepartmenttype} from  "@/api/departmentManage";
	/*  */
  export default {
	  props: {
	    title: {
